...
import sys
import os
sys.path.append(os.path.abspath(os.path.join("/home/docker_rctrans/RCTrans/projects/mmdet3d_plugin/models/backbones")))
# sys.path.append(os.path.abspath(os.path.join("/media/matykina_ov/FastSSD/RCTrans/BEVCar")))
...
from nets.dino_v2_with_adapter.dino_v2_adapter.adapter_modules import (
    InteractionBlock,
